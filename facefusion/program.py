...
def create_uis_program() -> ArgumentParser:
	...
	group_uis.add_argument('--server-name', help = translator.get('help.server_name'), default = config.get_str_value('uis', 'server_name', '0.0.0.0'))
	group_uis.add_argument('--server-port', help = translator.get('help.server_port'), type = int, default = config.get_int_value('uis', 'server_port', '7860'))
	return program
