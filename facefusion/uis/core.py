...
def launch() -> None:
	...
	# Get the first UI layout module to run the server
	first_ui_layout = state_manager.get_item('ui_layouts')[0]
	first_ui_layout_module = load_ui_layout_module(first_ui_layout)
	first_ui_layout_module.run(ui)
